<?php
    ...
    $pdf->setXY(2,$get_YD);
    $pdf->MultiCell(73, 4.2, 'RNC : '.$nrc, 0,'C',0 ,1);
    ...
    $pdf->MultiCell(73, 4.2, 'No. Registro : '.$numero_resolucion, 0,'C',0 ,1);

    $pdf->setXY(2,$get_YD + 12);
    $pdf->MultiCell(73, 4.2, 'Fecha Registro : '.$fecha_resolucion, 0,'C',0 ,1);
